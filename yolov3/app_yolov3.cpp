...
class YOLOV3 : public yolo::YOLO
{
public:
	YOLOV3(const utils::InitParameter& param);
	~YOLOV3();
};

YOLOV3::YOLOV3(const utils::InitParameter& param) :yolo::YOLO(param)
{
}
...
void task(YOLOV3& yolo, const utils::InitParameter& param, std::vector<cv::Mat>& imgsBatch, const int& delayTime, const int& batchi,
