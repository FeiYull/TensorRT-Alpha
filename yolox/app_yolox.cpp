...
void task(YOLOX& yolo, const utils::InitParameter& param, std::vector<cv::Mat>& imgsBatch, const int& delayTime, const int& batchi,
...
int main(int argc, char** argv)
{
	...
	setParameters(param);
	// path
	std::string model_path = "../../data/yolox/yolox_nano.trt";
